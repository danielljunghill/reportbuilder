	...
	function (result, model) {
		if (result.$ === 'Ok') {
			...
			return $author$project$Model$ReportWithoutError(
				{report: report, selection: $elm$core$Maybe$Nothing});
		} else {
			var err = result.a;
			return A2($author$project$Model$addError, model, err);
		}
	});
var $author$project$Main$initialModel = A2($author$project$Model$update, $author$project$Report$Mock$mockReport, $elm$core$Maybe$Nothing);
...
var $author$project$Model$Selecting = function (a) {
		...
		switch (msg.$) {
			case 'Select':
				...
				return function (m) {
					...
					A2(
						$author$project$Model$select,
						$author$project$Model$Selecting(item),
						model));
			case 'Edit':
				var _v1 = msg.a;
				var item = _v1.a;
				...
				return function (m) {
					...
					A2(
						$author$project$Model$select,
						$author$project$Model$Editing(item),
						model));
			default:
				var test = A2($elm$core$Debug$log, 'DoNothing', 'Absolutly nothing');
...
var $author$project$Koncepts$CubeDimension$CubeRowOffset = function (a) {
...
var $author$project$Koncepts$CubeDimension$MemberHeader = function (a) {
...
var $author$project$Koncepts$CubeDimension$calculateSpan = F2(
	function (dimension, _v0) {
		var span = _v0.a;
		if (dimension.$ === 'DimensionWithDefault') {
			var _v2 = dimension.a;
			var domain = _v2.b;
			return $author$project$Koncepts$Area$Span(
				(span / ($author$project$NList$length(domain.members) + 1)) | 0);
		} else {
...
var $author$project$Koncepts$CubeDimension$calculateStart = F3(
...
var $author$project$Koncepts$CubeDimension$calculateArea = F4(
	function (dimension, direction, area, ordinal) {
		if (direction.$ === 'Horizontal') {
			...
			var hSpan = $author$project$Koncepts$Area$HorizontalSpan(
				A2(
					$author$project$Koncepts$CubeDimension$calculateSpan,
					dimension,
			...
			var hStart = $author$project$Koncepts$Area$HorizontalStart(
				A3(
					$author$project$Koncepts$CubeDimension$calculateStart,
					ordinal,
...
var $author$project$NList$mapi = F2(
	function (f, m) {
		var innerMapi = F2(
			function (i, im) {
				if (!im.b) {
					...
					return _Utils_ap(
						...
						A2(innerMapi, i + 1, tail));
				}
			});
		return {
			head: A2(f, 0, m.head),
			tail: A2(innerMapi, 1, m.tail)
		};
	});
var $author$project$Lists$maybeAsList = function (a) {
	if (a.$ === 'Just') {
		var v = a.a;
		return _List_fromArray(
			[v]);
...
var $author$project$Koncepts$Model$memberDefault = function (dimension) {
	if (dimension.$ === 'DimensionWithDefault') {
		var _v1 = dimension.a;
		var d = _v1.a;
...
var $author$project$Koncepts$CubeDimension$addDimensionToTableHeaders = F4(
	function (direction, span, dimension, acc) {
		var initArea = F2(
		...
		if (!acc.b) {
			...
			return A2(
				...
				A2($author$project$Koncepts$CubeDimension$addDimensionToTableHeader, direction, dimension),
				acc);
		}
	});
...
var $author$project$Koncepts$CubeDimension$calculateTableHeaders = F2(
	function (direction, dimensions) {
		var recFold = F3(
			function (span, acc, dims) {
				recFold:
				while (true) {
					if (!dims.b) {
						return acc;
						...
						var head = dims.a;
						var tail = dims.b;
						var state = A4($author$project$Koncepts$CubeDimension$addDimensionToTableHeaders, direction, span, head, acc);
						var $temp$span = span,
							$temp$acc = state,
							$temp$dims = tail;
						span = $temp$span;
		...
		var totalSpanForDimensions = $author$project$Koncepts$CubeDimension$calculateSpanForDimensions(dimensions);
		return A3(recFold, totalSpanForDimensions, _List_Nil, dimensions);
	});
...
var $author$project$Koncepts$CubeDimension$tableHeaderToDimensionColumnHeader = F2(
	function (selectedFactors, _v0) {
		var dimensionHeaders = _v0.a;
		var createDimensionColumnHeader = F2(
			function (isTotal, _v1) {
				var d = _v1.a;
		...
		return $author$project$NList$toList(
			A2(
				$author$project$NList$map,
				function (dm) {
					return A2(createDimensionColumnHeader, true, dm);
				},
				dimensionHeaders));
	});
var $author$project$Koncepts$CubeDimension$dimensionColumnHeaders = F2(
	function (selection, headers) {
		return A2(
			$author$project$Lists$collect,
			$author$project$Koncepts$CubeDimension$tableHeaderToDimensionColumnHeader(selection),
			headers);
	});
...
var $author$project$Koncepts$CubeDimension$dimensionColumns = function (headers) {
	return A2(
		$elm$core$List$map,
		A2($elm$core$Basics$composeR, $author$project$Koncepts$CubeDimension$tableHeaderAsMembers, $author$project$Koncepts$CubeDimension$CubeColumn),
		headers);
};
...
var $author$project$Koncepts$CubeDimension$calculateCubeColumns = F3(
	function (direction, selection, dimensions) {
		var tableHeaders = A2($author$project$Koncepts$CubeDimension$calculateTableHeaders, direction, dimensions);
		var offset = function () {
			if (direction.$ === 'Horizontal') {
				return A2(
		...
		return {
			columns: $author$project$Koncepts$CubeDimension$dimensionColumns(tableHeaders),
			headers: A2($author$project$Koncepts$CubeDimension$dimensionColumnHeaders, selection, tableHeaders),
			offset: $author$project$Koncepts$CubeDimension$CubeRowOffset(offset)
		};
	});
...
var $author$project$Koncepts$CubeView$attrSelected = F2(
	function (c, b) {
...
var $author$project$Koncepts$CubeView$attrColumnHeaderSelected = $author$project$Koncepts$CubeView$attrSelected('grid-cell-selected');
...
var $author$project$Koncepts$CubeView$columnHeaderCell = F2(
	function (_v0, colunmHeader) {
		...
		return A2(
			...
			A2(
				$elm$core$List$append,
				$author$project$Koncepts$CubeView$attrColumnHeaderSelected(colunmHeader.isSelected),
				A2(
					$elm$core$List$append,
...
var $author$project$Koncepts$CubeView$factorsFromSelection = function (selection) {
	if (selection.$ === 'Editing') {
		var factors = selection.a;
		return factors;
	} else {
		var factors = selection.a;
		return factors;
...
var $author$project$Msg$Edit = function (a) {
	return {$: 'Edit', a: a};
};
...
var $author$project$Koncepts$CubeView$attrEventEditCell = F3(
	function (factors, row, attr) {
		var _v0 = row.item;
		if (_v0.$ === 'AbstractRow') {
			var ak = _v0.a;
			return attr;
...
var $author$project$Koncepts$CubeView$membersToFactors = $author$project$NList$map(
	function (m) {
		return m.factor;
	});
...
var $author$project$Koncepts$CubeView$cellFactors = F2(
	function (konceptRow, _v0) {
		var members = _v0.a;
		var _v1 = $author$project$Koncepts$CubeKoncept$tryGetValueKoncept(konceptRow.item);
		if (_v1.$ === 'Just') {
			var valueKoncept = _v1.a;
			return A2(
				$author$project$NList$addFirst,
				valueKoncept.factor,
				$author$project$Koncepts$CubeView$membersToFactors(members));
		} else {
			return $author$project$Koncepts$CubeView$membersToFactors(members);
		}
	});
var $author$project$Koncepts$CubeView$CellCreator = function (a) {
	return {$: 'CellCreator', a: a};
};
var $author$project$Koncepts$CubeView$MembersFactor = function (a) {
	return {$: 'MembersFactor', a: a};
};
...
var $author$project$Model$multiplyFactor = F2(
	function (_v0, _v1) {
		var a = _v0.a;
		var b = _v1.a;
		return $author$project$Koncepts$Model$Factor(a * b);
	});
var $author$project$Koncepts$CubeView$multiplyFactors = function (factors) {
	return A3(
		$author$project$NList$fold,
		$author$project$Model$multiplyFactor,
		$author$project$Koncepts$Model$Factor(1),
		factors);
};
var $author$project$Koncepts$CubeView$createMembersFactor = function (_v0) {
	var members = _v0.a;
	return $author$project$Koncepts$CubeView$MembersFactor(
		$author$project$Koncepts$CubeView$multiplyFactors(
			$author$project$Koncepts$CubeView$membersToFactors(members)));
};
var $author$project$Koncepts$CubeView$SelectionFactor = function (a) {
	return {$: 'SelectionFactor', a: a};
};
var $author$project$Koncepts$CubeView$createSelectionFactor = A2(
	$elm$core$Basics$composeR,
	$author$project$Koncepts$CubeView$factorsFromSelection,
	A2($elm$core$Basics$composeR, $author$project$Koncepts$CubeView$multiplyFactors, $author$project$Koncepts$CubeView$SelectionFactor));
var $author$project$Msg$DoNothing = {$: 'DoNothing'};
var $elm$html$Html$input = _VirtualDom_node('input');
var $author$project$Events$Custom$alwaysStop = function (x) {
...
var $author$project$Events$Custom$noPropapagation = F2(
	function (eventId, msg) {
		return A2(
			$elm$html$Html$Events$stopPropagationOn,
			eventId,
			A2(
				$elm$json$Json$Decode$map,
				$author$project$Events$Custom$alwaysStop,
				$elm$json$Json$Decode$succeed(msg)));
	});
			...
			_Utils_ap(
				_List_fromArray(
					[
						...
						$author$project$Events$Custom$onClickStopPropagation($author$project$Msg$DoNothing)
					]),
				attr),
			_List_Nil);
	});
var $author$project$Koncepts$CubeView$ValueFactor = function (a) {
	return {$: 'ValueFactor', a: a};
};
var $author$project$Koncepts$CubeView$attrAssociatedCell = $author$project$Koncepts$CubeView$attrSelected('grid-cell-member');
var $author$project$Koncepts$CubeView$attrSelectedCell = $author$project$Koncepts$CubeView$attrSelected('grid-cell-selected-1');
var $elm$core$Basics$modBy = _Basics_modBy;
var $author$project$Koncepts$CubeView$memberInSelection = F2(
	function (_v0, _v1) {
		var member = _v0.a.a;
		var selection = _v1.a.a;
		return !A2($elm$core$Basics$modBy, member, selection);
	});
var $author$project$Koncepts$CubeView$valueAndMemberInSelection = F3(
	function (_v0, _v1, _v2) {
		var member = _v0.a.a;
		var value = _v1.a.a;
		var selection = _v2.a.a;
		return _Utils_eq(member * value, selection);
	});
var $author$project$Koncepts$CubeView$valueInSelection = F2(
	function (_v0, _v1) {
		var value = _v0.a.a;
		var selection = _v1.a.a;
		return !A2($elm$core$Basics$modBy, value, selection);
	});
var $author$project$Koncepts$CubeView$selectionHtml = F6(
	function (skip, selectionFactor, konceptRow, membersFactor, attributes, _v0) {
		var createCell = _v0.a;
		if (skip) {
			return _Utils_Tuple2(
				skip,
				A2($author$project$Koncepts$CubeView$textCell, '', attributes));
		} else {
			var _v1 = $author$project$Koncepts$CubeKoncept$tryGetValueKoncept(konceptRow.item);
			if (_v1.$ === 'Just') {
				var koncept = _v1.a;
				if (A3(
					$author$project$Koncepts$CubeView$valueAndMemberInSelection,
					membersFactor,
					$author$project$Koncepts$CubeView$ValueFactor(koncept.factor),
					selectionFactor)) {
					return _Utils_Tuple2(
						true,
						A2(
							...
							A2(
								...
								$author$project$Koncepts$CubeView$attrSelectedCell(true),
								attributes)));
				} else {
					var isAssociated = A2(
						$author$project$Koncepts$CubeView$valueInSelection,
						$author$project$Koncepts$CubeView$ValueFactor(koncept.factor),
						selectionFactor) || A2($author$project$Koncepts$CubeView$memberInSelection, membersFactor, selectionFactor);
					return _Utils_Tuple2(
						false,
						A2(
							$author$project$Koncepts$CubeView$textCell,
							...
							A2(
								$author$project$Koncepts$CubeView$addAttr,
								$author$project$Koncepts$CubeView$attrAssociatedCell(isAssociated),
								attributes)));
				}
			} else {
				return _Utils_Tuple2(
					...
					A2(
						...
						A2(
							$author$project$Koncepts$CubeView$addAttr,
							$author$project$Koncepts$CubeView$attrAssociatedCell(
								A2($author$project$Koncepts$CubeView$memberInSelection, membersFactor, selectionFactor)),
							attributes)));
			}
		}
	});
var $author$project$Koncepts$CubeView$cellHtml = F5(
	function (skip, maybeSelection, konceptRow, cubeColumn, attributes) {
		if (maybeSelection.$ === 'Just') {
			var selection = maybeSelection.a;
			var selectionFactor = $author$project$Koncepts$CubeView$createSelectionFactor(selection);
			var memberFactor = $author$project$Koncepts$CubeView$createMembersFactor(cubeColumn);
			if (selection.$ === 'Selecting') {
				return A6(
					$author$project$Koncepts$CubeView$selectionHtml,
					skip,
					selectionFactor,
					konceptRow,
					memberFactor,
					attributes,
					$author$project$Koncepts$CubeView$CellCreator($author$project$Koncepts$CubeView$textCell));
			} else {
				return A6(
					$author$project$Koncepts$CubeView$selectionHtml,
					skip,
					...
					memberFactor,
					attributes,
					$author$project$Koncepts$CubeView$CellCreator($author$project$Koncepts$CubeView$inputCell));
			}
		} else {
			return _Utils_Tuple2(
				skip,
...
var $author$project$Koncepts$CubeView$cell = F8(
	function (direction, area, selection, columnIndex, column, rowIndex, row, state) {
		var selectionAttributes = A4($author$project$Koncepts$CubeView$cellHtml, state.a, selection, row, column);
		var newCell = selectionAttributes(
			A3(
				$author$project$Koncepts$CubeView$attrEventEditCell,
				A2($author$project$Koncepts$CubeView$cellFactors, row, column),
				row,
				A2(
					$author$project$Koncepts$CubeView$addAttr,
					$author$project$Koncepts$CubeView$attrBox,
...
var $author$project$Koncepts$Area$oneHorizontalSpan = $author$project$Koncepts$Area$HorizontalSpan(
	$author$project$Koncepts$Area$Span(1));
var $author$project$Koncepts$CubeView$gridCells = F4(
	function (direction, selection, cubeColumns, cubeRows) {
		var area = A2(
...
var $author$project$Koncepts$CubeView$attrRowHeaderSelected = $author$project$Koncepts$CubeView$attrSelected('grid-cell-selected');
	...
	function (_v0, selection, rowHeader) {
		...
		return A2(
			...
			A2(
				...
				A2(
					$author$project$Koncepts$CubeView$addAttr,
					$author$project$Koncepts$CubeView$attrRowHeaderSelected(selected),
					A2(
						$author$project$Koncepts$CubeView$addAttr,
...
var $author$project$Koncepts$CubeView$viewCube = F4(
	function (direction, hyperCube, koncepts, selection) {
		var selectionFactors = function () {
			if (selection.$ === 'Just') {
				var s = selection.a;
				return $author$project$NList$toList(
					$author$project$Koncepts$CubeView$factorsFromSelection(s));
			} else {
				return _List_Nil;
			}
		}();
		...
		var cubeColumns = A3($author$project$Koncepts$CubeDimension$calculateCubeColumns, direction, selectionFactors, dimensions);
		var rowHeaders = A2(
			$elm$core$List$map,
			function (rowHeader) {
				return A3($author$project$Koncepts$CubeView$rowHeaderCellIndented, cubeColumns.offset, selectionFactors, rowHeader);
			},
			cubeRows.rows);
		var columns = A2(
			$elm$core$List$map,
			...
			cubeColumns.headers);
		var cells = A4($author$project$Koncepts$CubeView$gridCells, direction, selection, cubeColumns, cubeRows);
		return A2(
			$elm$html$Html$div,
			A2(
...
var $author$project$Koncepts$View$divKoncept = F2(
	function (selection, koncept) {
		switch (koncept.$) {
			case 'Value':
				var vk = koncept.a;
			...
			case 'Abstract':
				...
				return A2(
					...
					A2(
						$elm$core$List$map,
						$author$project$Koncepts$View$divKoncept(selection),
						kl));
			default:
				var _v2 = koncept.a;
				var hc = _v2.a;
				...
				return A2(
					...
					_List_fromArray(
						[
							...
							A4($author$project$Koncepts$CubeView$viewCube, $author$project$Koncepts$Area$Horizontal, hc, dk, selection)
						]));
		}
	});
var $author$project$Koncepts$View$toHtml = function (selection) {
	return $author$project$Koncepts$View$divKoncept(selection);
};
var $author$project$Page$View$toHtml = F2(
	function (selection, page) {
		var koncepts = A2(
			$elm$core$List$map,
			$author$project$Koncepts$View$toHtml(selection),
			page.koncepts);
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
...
var $author$project$Report$View$toHtml = F2(
	function (selection, report) {
		var pages = A2(
			$elm$core$List$map,
			$author$project$Page$View$toHtml(selection),
			A2(
				$elm$core$List$filter,
				function (page) {
...
var $author$project$Model$tryGetSelection = A2(
	$elm$core$Basics$composeR,
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					$author$project$Model$tryGetSelection(model),
					report),
