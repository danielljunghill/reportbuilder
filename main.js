	...
	function (result, model) {
		if (result.$ === 'Ok') {
			...
			return $author$project$Model$ReportWithoutError(
				{report: report, selectedItem: $elm$core$Maybe$Nothing});
		} else {
			var err = result.a;
...
var $author$project$Model$selectItem = F2(
	function (item, model) {
		switch (model.$) {
			case 'NoReportWithError':
				var err = model.a;
	...
	function (msg, model) {
		if (msg.$ === 'Select') {
			...
			return function (m) {
				...
				A2($author$project$Model$selectItem, item, model));
		} else {
...
var $author$project$Main$konceptButton = function (_v0) {
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$text('add Koncept')
			]));
};
var $author$project$Msg$AddPage = {$: 'AddPage'};
var $author$project$Main$pageButton = A2(
	$elm$html$Html$button,
	_List_fromArray(
		[
			$elm$html$Html$Events$onClick($author$project$Msg$AddPage)
		]),
	_List_fromArray(
		[
...
var $author$project$Model$SelectedPage = function (a) {
	return {$: 'SelectedPage', a: a};
};
var $author$project$Msg$selectPage = A2($elm$core$Basics$composeR, $author$project$Model$SelectedPage, $author$project$Msg$Select);
...
var $author$project$Model$SelectedAbstract = function (a) {
	return {$: 'SelectedAbstract', a: a};
};
var $author$project$Msg$selectAbstract = A2($elm$core$Basics$composeR, $author$project$Model$SelectedAbstract, $author$project$Msg$Select);
...
var $author$project$Model$SelectedValue = function (a) {
	return {$: 'SelectedValue', a: a};
};
var $author$project$Msg$selectValue = A2($elm$core$Basics$composeR, $author$project$Model$SelectedValue, $author$project$Msg$Select);
...
var $author$project$Koncepts$CubeDimension$TotalHeader = function (a) {
...
var $author$project$Koncepts$CubeDimension$calculateDefaultArea = F3(
...
var $author$project$Lists$rev = function (m) {
	var recRevers = function (mi) {
		if (!mi.b) {
			return _List_Nil;
		} else {
			var head = mi.a;
...
var $author$project$NList$last = function (m) {
	var _v0 = $author$project$Lists$rev(m.tail);
	if (!_v0.b) {
		return m.head;
	} else {
		var head = _v0.a;
...
var $author$project$Koncepts$CubeDimension$fromDimension = F5(
	function (direction, depth, area, dimension, parentMembers) {
		var getLastArea = function (headers) {
			return function (_v2) {
				var item = _v2.a;
				return item.area;
			}(
				$author$project$NList$last(headers));
		};
		var dms = $author$project$Koncepts$Model$dimensionMembers(dimension);
		var memberHeaders = A2(
			...
			dms);
		var dm = $author$project$Koncepts$Model$memberDefault(dimension);
		var defaultMemberHeader = A2(
			$elm$core$Maybe$map,
			function (_v0) {
				var md = _v0.a;
				return A3(
					$author$project$Koncepts$CubeDimension$createDimensionHeader,
					A3(
						$author$project$Koncepts$CubeDimension$calculateDefaultArea,
						direction,
						depth,
						getLastArea(memberHeaders)),
					parentMembers,
					md);
			},
			dm);
		return _Utils_Tuple2(memberHeaders, defaultMemberHeader);
	});
...
var $author$project$Koncepts$CubeDimension$dimensionAsTableHeader = F4(
	function (direction, depth, dimension, headers) {
		var mapHeaders = F2(
			function (i, hs) {
		...
		var columnHeaders = function (_v0) {
			...
			var area = item.area;
			return A5($author$project$Koncepts$CubeDimension$fromDimension, direction, depth, area, dimension, members);
		};
		var result = columnHeaders(header);
		var v1 = A2(
			$author$project$NList$mapi,
			F2(
				function (i, m) {
		...
		var v2 = A2(
			$elm$core$List$map,
			A2($elm$core$Basics$composeR, $author$project$NList$create, $author$project$Koncepts$CubeDimension$TotalHeader),
			$author$project$Lists$maybeAsList(result.b));
		return A2($author$project$NList$addList, v1, v2);
	});
var $author$project$Koncepts$CubeDimension$addDimensionToTableHeader = F4(
	function (direction, depth, dimension, acc) {
		var result = function () {
			if (acc.$ === 'TotalHeader') {
				return $author$project$NList$create(acc);
			} else {
				var dimensionHeaders = acc.a;
				return A4($author$project$Koncepts$CubeDimension$dimensionAsTableHeader, direction, depth, dimension, dimensionHeaders);
			}
		}();
...
var $author$project$Koncepts$CubeDimension$addDimensionToTableHeaders = F5(
	function (direction, depth, span, dimension, acc) {
		...
		if (!acc.b) {
			...
			var mt = A5($author$project$Koncepts$CubeDimension$fromDimension, direction, depth, area, dimension, _List_Nil);
			var v1 = A2(
			...
			var v2 = A2(
				$elm$core$List$map,
				A2($elm$core$Basics$composeR, $author$project$NList$create, $author$project$Koncepts$CubeDimension$TotalHeader),
				$author$project$Lists$maybeAsList(mt.b));
			return $author$project$NList$toList(
				A2($author$project$NList$addList, v1, v2));
		} else {
			return A2(
				$author$project$Lists$collect,
				A3($author$project$Koncepts$CubeDimension$addDimensionToTableHeader, direction, depth, dimension),
				acc);
		}
	});
	...
	var recCalculateSpan = function (d) {
		if (!d.b) {
			...
			if (head.$ === 'DimensionWithDefault') {
				var _v2 = head.a;
				var m = _v2.b;
				return ($author$project$NList$length(m.members) * recCalculateSpan(tail)) + 1;
			} else {
				var m = head.a;
...
var $author$project$Koncepts$CubeDimension$calculateTableHeaders = F2(
	function (direction, dimensions) {
		var calculateNextDepth = function (_v1) {
			var d = _v1.a;
			return $author$project$Koncepts$Area$Depth(d - 1);
		};
		var recFold = F4(
			function (span, depth, acc, dims) {
				recFold:
				while (true) {
					if (!dims.b) {
						return acc;
						...
						var head = dims.a;
						var tail = dims.b;
						var state = A5($author$project$Koncepts$CubeDimension$addDimensionToTableHeaders, direction, depth, span, head, acc);
						var nextDepth = calculateNextDepth(depth);
						var $temp$span = span,
							$temp$depth = nextDepth,
							$temp$acc = state,
							$temp$dims = tail;
						span = $temp$span;
						depth = $temp$depth;
		...
		return A4(
			recFold,
			totalSpanForDimensions,
			$author$project$Koncepts$Area$Depth(
...
var $author$project$Model$SelectedCell = function (a) {
	return {$: 'SelectedCell', a: a};
};
var $author$project$Koncepts$CubeView$attrOnClickCell = F3(
	function (_v0, row, attr) {
		var members = _v0.a;
		var _v1 = row.item;
		if (_v1.$ === 'AbstractRow') {
			var ak = _v1.a;
			...
			var event = $elm$html$Html$Events$onClick(
				$author$project$Msg$Select(
					$author$project$Model$SelectedCell(
						_Utils_Tuple2(
							vk,
							$author$project$NList$toList(members)))));
			return _Utils_ap(
				_List_fromArray(
					[event]),
				attr);
...
var $author$project$Koncepts$Model$factorToInt = function (_v0) {
	var i = _v0.a;
	return i;
};
var $author$project$Koncepts$CubeView$factorFromMemberList = function (members) {
	if (!members.b) {
		return 1;
	} else {
		var head = members.a;
		var tail = members.b;
		return function (i) {
			return i * $author$project$Koncepts$CubeView$factorFromMemberList(tail);
		}(
			$author$project$Koncepts$Model$factorToInt(head.factor));
	}
};
var $author$project$Koncepts$CubeView$factorFromValue = F2(
	function (vk, mv) {
		return function (i) {
			return i * mv;
		}(
			$author$project$Koncepts$Model$factorToInt(vk.factor));
	});
var $author$project$Koncepts$CubeView$factorFromSelection = function (vk) {
	return A2(
		$elm$core$Basics$composeR,
		$author$project$Koncepts$CubeView$factorFromMemberList,
		$author$project$Koncepts$CubeView$factorFromValue(vk));
};
...
var $author$project$Koncepts$CubeView$calculateIfCellIsSelected = F3(
	function (selection, konceptRow, _v0) {
		var cellMembers = _v0.a;
		if (selection.$ === 'Nothing') {
			...
			var vk = _v2.a;
			var members = _v2.b;
			var _v3 = $author$project$Koncepts$CubeKoncept$tryGetValueKoncept(konceptRow.item);
			if (_v3.$ === 'Just') {
				var vkCell = _v3.a;
				var productSelection = A2($author$project$Koncepts$CubeView$factorFromSelection, vk, members);
				var productCell = A2(
					$author$project$Koncepts$CubeView$factorFromSelection,
					vkCell,
					$author$project$NList$toList(cellMembers));
				return _Utils_eq(productSelection, productCell);
			} else {
				return false;
			}
		}
	});
var $author$project$Koncepts$CubeView$attrSelectedCell = $author$project$Koncepts$CubeView$attrSelected('grid-cell-selected');
var $author$project$Koncepts$CubeView$trySelectCell = F4(
	function (skip, selection, row, _v0) {
		var cellMembers = _v0.a;
		if (skip) {
			return _List_Nil;
		} else {
			var result = function () {
				if (selection.$ === 'Nothing') {
					...
					var vk = _v2.a;
					var members = _v2.b;
					var _v3 = $author$project$Koncepts$CubeKoncept$tryGetValueKoncept(row.item);
					if (_v3.$ === 'Just') {
						var vkCell = _v3.a;
						var productSelection = A2($author$project$Koncepts$CubeView$factorFromSelection, vk, members);
						var productCell = A2(
							...
							vkCell,
							$author$project$NList$toList(cellMembers));
						return $author$project$Koncepts$CubeView$attrSelectedCell(
							_Utils_eq(productSelection, productCell));
					} else {
						return _List_Nil;
					}
				}
...
var $author$project$Koncepts$CubeView$attrMemberCell = $author$project$Koncepts$CubeView$attrSelected('grid-cell-member');
var $author$project$Koncepts$CubeView$trySelectMemberCell = F4(
	function (skip, selection, row, _v0) {
		var cellMembers = _v0.a;
		if (skip) {
			return _List_Nil;
			...
			var result = function () {
				if (selection.$ === 'Nothing') {
					...
					if (_v3.$ === 'Just') {
						var vkCell = _v3.a;
						var productSelection = $author$project$Koncepts$CubeView$factorFromMemberList(members);
						var productCell = $author$project$Koncepts$CubeView$factorFromMemberList(
							$author$project$NList$toList(cellMembers));
						return $author$project$Koncepts$CubeView$attrMemberCell(
							_Utils_eq(productSelection, productCell) || _Utils_eq(vkCell.factor, vk.factor));
					} else {
						return _List_Nil;
					}
				}
...
var $author$project$Koncepts$CubeView$cell = F8(
	function (direction, area, selection, columnIndex, column, rowIndex, row, state) {
		var skipSelection = state.a;
		var newSelectionState = state.a ? true : A3($author$project$Koncepts$CubeView$calculateIfCellIsSelected, selection, row, column);
		var newCell = function () {
			if (direction.$ === 'Horizontal') {
				return A2(
					...
					'',
					A3(
						$author$project$Koncepts$CubeView$attrOnClickCell,
						column,
						row,
						A2(
							$author$project$Koncepts$CubeView$addAttr,
							A4($author$project$Koncepts$CubeView$trySelectMemberCell, skipSelection, selection, row, column),
							A2(
								$author$project$Koncepts$CubeView$addAttr,
								A4($author$project$Koncepts$CubeView$trySelectCell, skipSelection, selection, row, column),
								A2(
									$author$project$Koncepts$CubeView$addAttr,
									$author$project$Koncepts$CubeView$attrBox,
									A2(
										...
										$author$project$Koncepts$CubeView$attributeGridArea(
											A2(
												...
												A2(
													$author$project$Koncepts$Area$addHorizontalStart,
													$author$project$Koncepts$Area$HorizontalStart(
														$author$project$Koncepts$Area$Start(columnIndex)),
													area)))))))));
			} else {
				return A2(
					$author$project$Koncepts$CubeView$textCell,
				...
				var newState = A3(
					...
					F3(
						function (i, state, row) {
							return A8($author$project$Koncepts$CubeView$cell, direction, area, selection, columnIndex, cubeColumn, i + 1, row, state);
						}),
...
var $author$project$Koncepts$CubeView$rowHeaderCellIndented = F3(
	function (_v0, selection, rowHeader) {
		...
		var selected = function () {
			if (selection.$ === 'Just') {
				var vk = selection.a;
				var _v2 = $author$project$Koncepts$CubeKoncept$konceptRowFactor(rowHeader.item);
				if (_v2.$ === 'Just') {
					var factor = _v2.a;
					return _Utils_eq(factor, vk.factor);
				} else {
					return false;
				}
			} else {
		...
		return A2(
			...
			A2(
				...
				A2(
					...
					A2(
						$author$project$Koncepts$CubeView$addAttr,
						$author$project$Koncepts$CubeView$attrIndentHorizontalStart(newArea.horizontalStart),
...
var $author$project$Koncepts$CubeView$viewCube = F4(
	function (direction, hyperCube, koncepts, selection) {
		...
		var cubeColumns = A3($author$project$Koncepts$CubeDimension$calculateCubeColumns, direction, selectedFilter.b, dimensions);
		var rowHeaders = A2(
			$elm$core$List$map,
			function (rowHeader) {
				return A3($author$project$Koncepts$CubeView$rowHeaderCellIndented, cubeColumns.offset, selectedFilter.a, rowHeader);
			},
			cubeRows.rows);
		var columns = A2(
			$elm$core$List$map,
